...
$lang = array_merge($lang, [
	...
	'HP4G_RESET_TITLE'		=> 'Reset HidePost4Guest settings',
	'HP4G_RESET_LABEL'		=> 'Reset all HidePost4Guest settings',
	'HP4G_RESET_EXPLAIN'	=> 'Click the button to reset all HidePost4Guest settings (pruning database). This action cannot be undone.',
	'HP4G_RESET_BUTTON'		=> 'Reset HidePost4Guest Settings',
	'HP4G_RESET_CONFIRM'	=> 'Are you sure you want to reset all HidePost4Guest settings? This action cannot be undone.',
	'HIDDEN_TO_GUEST' 		=> 'This forum is already hidden to Guests',
	'HP4G_RESET_SUCCESS' 	=> 'All HidePost4Guest settings have been successfully reset.',
]);
